...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesnoviembre1-45.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from octubre where octubre.nss not in (select noviembre.nss from noviembre) HAVING subdelegacion=45;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
?>
                        ...
                        <a class="btn btn-success" href="adeudomesnoviembre.php" role="button">Regresar</a> 
