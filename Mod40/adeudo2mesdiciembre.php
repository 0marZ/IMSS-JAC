...
<body>
 ...
 <ul>
  ...
  <li><a href="adeudo2mesdiciembre-02.php">Orizaba</a></li>
  <li><a href="adeudo2mesdiciembre-03.php">Cordoba</a></li>
    <li><a href="adeudo2mesdiciembre-38.php">Cosamaloapan</a></li>
	  <li><a href="adeudo2mesdiciembre-45.php">Coatzacoalcos</a></li>
...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesdiciembre2.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM octubre WHERE nss NOT IN(SELECT nss FROM noviembre) AND nss NOT IN(SELECT nss FROM diciembre);') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
