...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mora de Pagos Febrero-Coatzacoalcos.
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesfebrero2-45.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM diciembre WHERE nss NOT IN(SELECT nss FROM enero) AND nss NOT IN(SELECT nss FROM febrero) HAVING subdelegacion=45;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
?>
                     ...
                     <a class="btn btn-success" href="adeudo2mesfebrero.php" role="button">Regresar</a>   
