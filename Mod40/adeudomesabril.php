...
<body>
 ...
 <ul>
  ...
  <li><a href="adeudomesabril-02.php">Orizaba</a></li>
  <li><a href="adeudomesabril-03.php">Cordoba</a></li>
    <li><a href="adeudomesabril-38.php">Cosamaloapan</a></li>
	  <li><a href="adeudomesabril-45.php">Coatzacoalcos</a></li>
...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesabril1.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from marzo where marzo.nss not in (select abril.nss from abril)') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
