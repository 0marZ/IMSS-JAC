...
<body>
 ...
 <ul>
  ...
  <li><a href="agosto 02.php">Orizaba</a></li>
    <li><a href="agosto 03.php">Cordoba</a></li>
  <li><a href="agosto 38.php">Cosamaloapan</a></li>
	  <li><a href="agosto 45.php">Coatzacoalcos</a></li>
		  <li><a href="adeudomesagosto.php">Adeudo 1 mes</a></li>
		    <li><a href="adeudo2mesagosto.php">Adeudo 2 mes</a></li>
    </div>
  </li>
</ul>
...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos de Mod 40 Agosto.
...
<?php foreach ($link->query('SELECT * from agosto') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
