...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesmarzo1-02.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from febrero where febrero.nss not in (select marzo.nss from marzo) HAVING subdelegacion=02; ') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
