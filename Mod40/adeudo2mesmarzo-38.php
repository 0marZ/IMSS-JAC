...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mora de Pagos Marzo-Cosamaloapan.
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesmarzo2-38.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM enero WHERE nss NOT IN(SELECT nss FROM febrero) AND nss NOT IN(SELECT nss FROM marzo) HAVING subdelegacion=38;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
