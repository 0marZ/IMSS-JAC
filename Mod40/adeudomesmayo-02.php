...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesmayo1-02.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from abril where abril.nss not in (select mayo.nss from mayo) HAVING subdelegacion=02;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
