...
<body>
 ...
 <ul>
  ...
  <li><a href="adeudomesmayo-02.php">Orizaba</a></li>
  <li><a href="adeudomesmayo-03.php">Cordoba</a></li>
    <li><a href="adeudomesmayo-38.php">Cosamaloapan</a></li>
	  <li><a href="adeudomesmayo-45.php">Coatzacoalcos</a></li>
...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesmayo1.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from abril where abril.nss not in (select mayo.nss from mayo)') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
