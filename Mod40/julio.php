...
<body>
 ...
 <ul>
  ...
  <li><a href="julio 02.php">Orizaba</a></li>
    <li><a href="julio 03.php">Cordoba</a></li>
  <li><a href="julio 38.php">Cosamaloapan</a></li>
	  <li><a href="julio 45.php">Coatzacoalcos</a></li>
		  <li><a href="adeudomesjulio.php">Adeudo 1 mes</a></li>
		    <li><a href="adeudo2mesjulio.php">Adeudo 2 mes</a></li>
    </div>
  </li>
</ul>
...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos de Mod 40 Julio.
...
<?php foreach ($link->query('SELECT * from julio') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
