...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mora de Pagos Noviembre-Orizaba.
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesnoviembre2-02.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM septiembre WHERE nss NOT IN(SELECT nss FROM octubre) AND nss NOT IN(SELECT nss FROM noviembre) HAVING subdelegacion=02;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
