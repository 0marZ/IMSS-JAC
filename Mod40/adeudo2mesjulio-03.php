...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mora de Pagos Julio-Cordoba.
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesjulio2-03.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM mayo WHERE nss NOT IN(SELECT nss FROM junio) AND nss NOT IN(SELECT nss FROM julio) HAVING subdelegacion=03;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
