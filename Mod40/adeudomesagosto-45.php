...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesagosto1-45.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from julio where julio.nss not in (select agosto.nss from agosto) HAVING subdelegacion=45; ') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
?>
                        ...
                        <a class="btn btn-success" href="adeudomesagosto.php" role="button">Regresar</a> 
