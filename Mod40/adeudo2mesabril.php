...
<body>
 ...
 <ul>
  ...
  <li><a href="adeudo2mesabril-02.php">Orizaba</a></li>
  <li><a href="adeudo2mesabril-03.php">Cordoba</a></li>
    <li><a href="adeudo2mesabril-38.php">Cosamaloapan</a></li>
	  <li><a href="adeudo2mesabril-45.php">Coatzacoalcos</a></li>
...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Mora de Pagos Abril.
						
						</h1>

	 <link href="css/datatable/datatable.css" rel="stylesheet" />
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesabril2.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
	 
		<div class="panel panel-default">
                        <div class="panel-heading">
                           Adeudos del mes de abril:  
                        </div>
...
<?php foreach ($link->query('SELECT DISTINCT * FROM febrero WHERE nss NOT IN(SELECT nss FROM marzo) AND nss NOT IN(SELECT nss FROM abril);') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
