...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos MOD 40 Orizaba-Febrero
...
<?php foreach ($link->query('SELECT `subdelegacion`, `nss`, `nombre` FROM `febrero` WHERE subdelegacion=02') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
...
?>
  ...
  <br>
    <center><p>&copy; 2023 IMSS. Todos los derechos reservados.</p></center>
	 ...
	 <img class="iconos" src="img/Inferior.png" style= "height: auto; width:100%">ss="iconos" src="img/Inferior.png" style= "height: auto; width:100%">
