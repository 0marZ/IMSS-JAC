...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos de MOD 40 Coatzacoalcos-Marzo
...
<?php foreach ($link->query('SELECT `subdelegacion`, `nss`, `nombre` FROM `marzo` WHERE subdelegacion=45') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
