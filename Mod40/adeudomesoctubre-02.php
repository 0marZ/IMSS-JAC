...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesoctubre1-02.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from septiembre where septiembre.nss not in (select octubre.nss from octubre) HAVING subdelegacion=02;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
