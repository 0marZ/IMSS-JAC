...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos MOD 40 Cordoba-Agosto.
...
<?php foreach ($link->query('SELECT `subdelegacion`, `nss`, `nombre` FROM `agosto` WHERE subdelegacion=03') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
