...
$pdf->SetFont('Arial','',10);
$pdf-> Cell(-132,20, 'mora por mas de 1 meses con base en el Articulo 220 fraccion II de la Ley del Seguro Social Vigente.',0,0,'C',0);
$pdf->SetFont('Arial','',10);
...
$consulta = "Select DISTINCT * from noviembre where noviembre.nss not in (select diciembre.nss from diciembre)";
