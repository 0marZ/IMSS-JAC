...
?>
	 ...
	 <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Pagos de Mod 40 Septiembre.
...
<?php foreach ($link->query('SELECT * from septiembre') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
