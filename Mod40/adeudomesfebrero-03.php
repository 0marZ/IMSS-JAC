...
?>
 ...
 <div class="reportes">
   <a class="btn btn-success btn-sm btn-flat" href="reportesfebrero1-03.php"><span class="glyphicon glyphicon-print"></span>Imprimir Reporte</a>
   </div>
</br>
...
<?php foreach ($link->query('Select DISTINCT * from enero where enero.nss not in (select febrero.nss from febrero) HAVING subdelegacion=03;') as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
<tr>
