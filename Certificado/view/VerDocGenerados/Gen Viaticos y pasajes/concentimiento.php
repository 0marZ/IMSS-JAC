...
foreach ($words as $index => $word) {
    ...
    $pdf->Cell(70, 10, mb_convert_encoding($word, 'ISO-8859-1', 'UTF-8'), 0, 0, 'C'); // Imprime la palabra
}
...
if(isset($data->Transporte)) {
    switch ($data->Transporte) {
        ...
        case 'vehiculo_particular':
            ...
            $pdf->setY(140.9);
            $pdf->setX(58);
            $pdf->Cell(5,10,mb_convert_encoding('ACOMPAÑANTE', 'ISO-8859-1', 'UTF-8'));
            break;
    ...
    $pdf->setY(200);
    $pdf->setX(50);
    $pdf->Cell(0,10,mb_convert_encoding('Tipo de transporte', 'ISO-8859-1', 'UTF-8'),0,1);
}
...
$pdf->setY(87);
$pdf->setX(63);
$pdf->Cell(0, 10, mb_convert_encoding(''.$data->Motivo, 'ISO-8859-1', 'UTF-8'), 0, 1, 'C');
